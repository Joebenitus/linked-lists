...
describe('LinkedList', () => {
  ...
  test('LinkedList.insertLast() should add a node at the head if a linked list has no head', () => {
    let linkedList = new LinkedList();
    linkedList.insertLast('head');
    expect(linkedList.head.data).toEqual('head');
  });

  test('LinkedList.insertLast() should add a node at the end of a linked list', () => {
